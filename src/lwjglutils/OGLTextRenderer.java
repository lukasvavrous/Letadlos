...
public class OGLTextRenderer {
	...
	public void addStr2D(int x, int y, String s) {
		if (s != null){
			...
			Rectangle2D textBox = gr.getFontMetrics().getStringBounds(s, 0, s.length(), gr);
	...
	public void xCenterAddStr2D(int y, String s, int fontSize, Color fontColor){
		if (s != null){
			Graphics gr = img.getGraphics();
			...
			int x = (int) ((width /2) - (textBox.getWidth()/2));
			...
			if (w>0 && h>0) {
				gr.setColor(new Color(255,0,0, 0));
				gr.fillRect(x1, y1, w, h);
	...
	public void customFontAddStr2D(int x, int y, String s, int fontSize, Color fontColor){
		if (s != null){
			Graphics gr = img.getGraphics();
	...
	public void customAddStr2D(int x, int y, String s) {
		if (s != null){
			Graphics gr = img.getGraphics();
